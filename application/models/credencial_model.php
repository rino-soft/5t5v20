...
class credencial_model extends CI_Model {
    ...
    function qrmasivo($codigo_cre) {
        ...
        $cadenaQR = "http://181.115.236.148/v4l1d4c10nd3cr3d3nc14l/v4l1d4c10n/St5v3r1f1c4c10n/";
        //**********
        $i=$codigo_cre;
            $nombre_QR = $i;
            $link=  dechex($i);
            
            $this->qr_cod_model->generar_QR_credencial($nombre_QR . "?" . $cadenaQR.$link);
