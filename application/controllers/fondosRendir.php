...
class fondosRendir extends CI_Controller {
...
//$padre,$hijo
    function index($padre,$proyecto=0) {
        echo "funciona";
        $data['titulo'] = 'Solicitud de Fondos a Rendir';
       // $data['datos_menu_superior'] = $this->menu_model->obtenerMenuPadre($this->session->userdata('id_admin')); //obtiene los menus asignados a 0 // en este caso no hay usuario
        ...
        $data['registros'] = $this->fondosRendir_model->listar_buscar_sol_frend($proyecto);
        ...
        $data['vista_enviada'] = 'fondosRendir/fondosrendir_view';
        $this->load->view('Plantilla/Plantilla_vista', $data);
    }

    function nuevo_solFR($id_rendicion) {
...
//            $detalle['datos_rendicion_detalle_sgrC'] = $this->rendiciones_model->obtener_detalle_datos_rendicion($id_rendicion, 'tel', 1);
        ...
        $this->load->view('fondosRendir/form_new_so_fr_view', $data);
    }
    function guardar_nueva_sfr()
    {
        echo $this->fondosRendir_model->save_sfr();
    }
