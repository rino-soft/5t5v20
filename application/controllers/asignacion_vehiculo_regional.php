    ...
    //new
     ...
     function guardar_vehiculo_taller_proyecto(){
      ...
      function asignar_vehiculo_proy_ta($id_vehiculo,$id_asignacion_proy_ta){
       ...
       $data['lista_vehi_prop']=$this->vehiculo_model->lista_vehiculo_contrato_estado('Propio','Activo');
        $data['lista_vehi_alqu']=$this->vehiculo_model->lista_vehiculo_contrato_estado('Alquilado','Activo');
