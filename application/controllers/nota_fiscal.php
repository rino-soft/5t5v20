...
class nota_fiscal extends CI_Controller {
    ...
    function index($padre, $hijo) {
       ...
       // echo "lega aqui";
        ...
        $data['vista_enviada'] = 'nota_fiscal/nota_fiscal_view';
    ...
    function nota_fiscal_nuevo($id_nf) {
        ...
        $this->load->view('nota_fiscal/nota_fiscal_new_view', $data);
    }

    function nota_fiscal_save() {
       echo $this->nota_fiscal_model->save_nota_fiscal();
    }
