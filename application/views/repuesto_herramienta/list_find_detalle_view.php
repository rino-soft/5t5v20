       ...
       <div class="grid_14 negrilla" >
           ...
           for($c=1;$c<=ceil($no_reg/$mostrar);$c++)
            {   if($c==$pagina)
                    ...
                    echo "<div class='milink link_blanco' onclick='cambiarpaginacion($c)' style='float:left;'>$c,</div>";
            }?>
               </div>
       </div>
   </div>
 <div class="grid_20 negrilla  fondo_azul f12 esparriba5 espabajo5">
...
<?php 
    if($consulta->num_rows()>0)
    {
        ...
        ?> <div class="grid_20 borde_abajo borde_arriba <?php echo $clase ;?>" id="<?php echo $res->id_serv_pro; ?>">
            <div class="grid_2">
                <input type="checkbox" <?php echo $chec;?> onchange="seleccionar_producto_herramienta('<?php echo $res->id_serv_pro; ?>')"
    ...
    {echo "no se han encontrado registros de este producto ";}
?>
