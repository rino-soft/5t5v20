    ...
    <div class=" x_panel col-md-12 col-sm-12 col-xs-12" id="cheque<?= $sps[$j] ?>" style="background: <?= $background ?>;">
        ...
        <div class="   col-md-12 col-sm-12 col-xs-12 ">
            <div class="   col-md-9 col-sm-9 col-xs-9 ">
                <spam class="f20 negrilla">  Cheque para: <?= $sp[5] ?> <?= $estado_sp ?></spam>
        ...
        <div class="   col-md-12 col-sm-12 col-xs-12  ">
            <?php 
                $clase="alert alert-success alert-dismissible fade in";
            if($sp[2]<0)
            {
                $clase="alert alert-danger alert-dismissible fade in";
            }
            ...
            for ($k = 0; $k < count($solicitudes); $k++) {
                ...
                if ($swsp == 0) {
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <label for="message">Nro <?= $sp[7] ?></label>
