<div class="x_panel">
    <div class="x_title bg-blue">
        <span class="f16 negrilla">Registro de cheque SP</span>
        <input type="hidden" id="documento" value="orden_pago_proveedor">
    ...
    <div class=" col-md-12 col-sm-12 col-xs-12 form-group">
        ...
        <div class=" col-md-12 col-sm-12 col-xs-12">
            <div class="col-md-4 col-sm-4 col-xs-8 form-group has-feedback">
                <input type="text" class="form-control has-feedback-left" placeholder="Nro Solicitud_pago" id="solpago_busqueda" onkeyup="buscar_sp(event);">
                <span class="fa fa-search form-control-feedback left" aria-hidden="true"></span>

            </div>
            <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                <div class="col-md-3 col-sm-3 col-xs-3"> <input type="text" class="form-control has-feedback-left" placeholder="Cheque inicial" id="inicial_cheque" onkeyup="buscar_sp(event);">
                ...
                <div class="col-md-2 col-sm-2 col-xs-2">
                    <button class="form-control has-feedback-left btn btn-dark" onclick="actualizar_cheques_sp()"> Actualizar</button>
