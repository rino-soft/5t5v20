...
if ($total_registros != 0) {
    ...
    <div class="fondo_azul colorAmarillo borde_abajo borde_arriba  negrilla f14" style="display: block-inline;float: left ; width: 100%; height: ">            
        <div class=" fondo_azul alin_cen f8" style="display: block-inline;float: left ;width: 3%">id</div>
        <!-- <div class=" fondo_azul alin_cen" style="display: block-inline;float: left ;width: 12%">Estado</div> -->
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 15%">Para</div>
        <div  class=" fondo_azul alin_izq" style="display: block-inline; float: left;width: 15%">Dirigido a</div>
        <!---<div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 20%">Llave de control</div>--->
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 7%">Fecha <br>Cheque</div>
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 6%">Monto </div>
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 7%">Fecha de Registro</div>
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 10%">Registro de</div>
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 20%">Comentario</div>
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 10%"></div>
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 10%"></div>
        <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 10%">
            <div class="botonResalta milink ocultar" id="botonbloqueimp"  style=" width: 80px;margin-top: 5px" onclick="">Imprimir</div>
 ...
 foreach ($registros->result() as $reg) {
        ...
        <div class="grid_20 borde_abajo <?php echo $clase; ?>  esparriba10  " style="width: 100%">
            <div class="f12 alin_cen " style="display: block-inline;float: left; width: 3%"> <?php echo $reg->id_cheque; ?></div>

            <div class="f10 negrilla alin_cen azulmarino" style="display: block-inline;  float: left; width: 15%"><?php echo $reg->detalle_dirigido_a."<br>"; ?></div>
            <div class="f12 alin_izq" style="display: block-inline;float: left; width: 15%"><?php echo $reg->dirigido."<br>"; ?></div>  

            <div class="f12 alin_cen" style="display: block-inline;float: left; width: 7%"><?php echo $reg->fecha_cheque . "<br>"; ?></div>
            <div class="f9 negrilla colorRojo alin_cen" style="display: block-inline;float: left; width: 6%;"><?php echo $reg->monto . "<br>"; ?></div>
            <div class="f10 alin_cen" style="display: block-inline;float: left; width: 7%"><?php echo $reg->fecha_registro."<br>"; ?></div>
            <div class="f10 alin_cen" style="display: block-inline;float: left; width: 10%"><?php echo $reg->nombre.' '.$reg->ap_paterno."<br>"; ?></div>
