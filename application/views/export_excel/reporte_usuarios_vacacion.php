...
$this->phpexcel->getActiveSheet()->getHeaderFooter()->setOddFooter('&L&IGenerado por GO STS V 1.0 el ' . date("d/m/Y") . '&I&RPágina &P de &N');
//imagen en excel
/*
...
$this->phpexcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('B' . $punt, 'CI')
        ->setCellValue('C' . $punt, 'PATERNO')
        ->setCellValue('D' . $punt, 'MATERNO')
        ->setCellValue('E' . $punt, 'NOMBRES')
        ->setCellValue('F' . $punt, 'DEPARTAMENTO')
        ->setCellValue('G' . $punt, 'V. CALCULADA')
        ->setCellValue('H' . $punt, 'V. UTILIZADA')
        ->setCellValue('I' . $punt, 'V. SALDO')
        ->setCellValue('J' . $punt, 'FECHA INGRESO')
        ->setCellValue('K' . $punt, 'FECHA NACIMIENTO')
        ->setCellValue('L' . $punt, 'XXX')
        ->setCellValue('M' . $punt, 'YYY');
