...
<div style="display:block; width: 100%;float: left">
    <div style="">
        <div  style="height: 35px ;padding:5px 5% 5px 5px; float: left">
            <div class="boton milink" style="float: left;" 
                 onclick="dialog_nueva_credencial('div_formularios_dialog', '<?php echo base_url() . "credenciales/credencial_nuevo/0"; ?> ')">
                Nueva Credencial
            </div>
       ...
       <input type="text" id="codigo_cre">
        <input type="button" onclick="qr_new()" value="crear qr">
    ...
    <script>
        $("#demo").barcode(                
                "100100", // Value barcode (dependent on the type of barcode)
                "code39" // type (string)
                ,{barWidth: 2,barHeight: 13,showHRI: false}
        );
    </script>-->
