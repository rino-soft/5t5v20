...
<style type="text/css">
    ...
    #datos_tabla td, #datos_tabla th, #datos_tabla caption {
        padding: 0.5em;
    }
    #datos_tabla thead tr, #datos_tabla tr:nth-child(even) {
        background: #f8f8f8;
    }
    #datos_tabla tr:hover {
        background: #f1f7ff;
    }

</style>
<script src="<?= base_url() ?>char/code/highcharts.js"></script>
<script src="<?= base_url() ?>char/code/modules/data.js"></script>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <button onclick="graficar_aqui()"></button>
            ...
            for ($i = 0; $i < count($items); $i++) {
                ...
                <tr>
                    ...
                    for ($f = 0; $f < count($meses_t); $f++) {
                        ...
                        echo '<td style="text-align: right">' . number_format($datos[$meses_t[$f][0]][$i], 2, ",", "") . '</td>';
                    }
                    ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table id="datatableX" data-order='[[0 , "desc" ]]' class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
