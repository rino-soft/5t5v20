...
<div class="col-md-12 col-sm-12 col-xs-12">
    <button class="btn btn-primary" onclick="mostrar_form_po(0)">Registrar Nueva POs</button>
</div>
                ...
                <table id="datatable" data-order='[[0 , "desc" ]]' class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody class ="f12">
                        ...
                        foreach ($registros_po->result() as $reg) {
                            ...
                            <tr>
                                <td><?php echo $reg->iditemSitiomonto; ?></td>

                                <td><?php echo $reg->nroPO; ?></td>
                                <td><?php echo substr($reg->descripcion, 0,80); ?></td>
                               <td><?php echo $reg->monto; ?></td>
                                <td><?php echo $reg->fecha_creacion; ?></td>


                                
                                <td><?php echo $reg->user_asignado; ?></td>


                                <td> <a class='btn btn-warning btn-xs' onclick="mostrar_form_po('<?= $reg->iditemSitiomonto ?>')">editar</a>
                                    <a class='btn btn-danger btn-xs' onclick="eliminar_item_po('<?= $reg->iditemSitiomonto ?>')">Eliminar</a><br>
