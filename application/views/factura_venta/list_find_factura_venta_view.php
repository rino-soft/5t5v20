        ...
        <div class="grid_20 borde_abajo <?php echo $clase; ?>  esparriba10  " style="width: 100%">
            ...
            <div class="f10 " style="display: block-inline;float: left; width: 13%">
                ...
                if ($proy_fac[$reg->id_factura]->num_rows() > 0)
                    echo "<span class='negrilla '>" . $proy_fac[$reg->id_factura]->row()->nombre . "<br></span>";
                else
                    echo "<span class='negrilla '>Sin proyecto<br></span>";
                if ($cont_fac[$reg->id_factura]->num_rows() > 0)
                    echo "<span class='colorAzul '>" . $cont_fac[$reg->id_factura]->row()->nro_contrato . " .- " . $cont_fac[$reg->id_factura]->row()->objeto . "<br></span>";
                else
            ...
            <div  style="display: block-inline;  float: left; width: 20%">
                ...
                <div class="fondo_plomo_atras fondo_redondeado" style="float: left; background: #000000;margin: 0 10px 0 0;"  title="Seleccion para Imprimir Factura">
                    <input class="milink" id="imp<?php echo $reg->id_factura; ?>" type="checkbox" onclick="insert_input('input_bloque_impresion',<?php echo $reg->id_factura; ?>)" >
                </div>
                ...
                <div class="impresionDoc milink"  title="Imprimir Factura"
                     onclick=" imp_factura_ventacontinuoPapel('<?php echo $reg->id_factura ?>'); ">
                </div>
                ...
                <div class="<?php echo $cobro_estilo; ?> milink"  title="Registrar Cobro"
                     onclick="formulario_cobro('formulario_pago','<?php echo base_url() . "factura_venta/formulario_registro_pago/" . $reg->id_factura; ?> ');">
                </div>
