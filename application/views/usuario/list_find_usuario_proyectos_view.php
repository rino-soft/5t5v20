...
if ($total_registros != 0) {
    ...
    <div style="display: block; padding: 5px;">
        ...
        foreach ($registros as $usuario) {
            ?>
            <div class="div450x170 fondo_celeste_usuario" style="position: relative;z-index:-1">
                <div class="" >

                    <div class="fondo_cabecera_usuario" style="width: 100%;height: 45px;position: absolute; background: #0B3156;">
                    ...
                    <div style="position: absolute;left: 5px;top:2px;width: 140px;" class='blanco_text'>
                        <div class="alin_cen f10"><?php echo $usuario->fh_registro; ?></div>
                        <div class="alin_cen"><?php
                      
                            $date1 = new DateTime();  
                            $date2 = new DateTime($usuario->fh_registro);
...
// will output 2 days       
					...
					<!--<div style="position: absolute; left:410px;top:40px;" class="boton_menunoo ocultar milink " title="menu de opciones" 
