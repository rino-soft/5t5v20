...
if ($id_send != 0) {
    ...
    $nom_subcategoria= $d_serv_prod->nombre;
    $llave = "disabled='disabled'";
    $estilo="NO grid_8";
    $titulo="<div class='colorRojo'>No editable</div>";
...
?>
    ...
    <?php if ($id_send != 0) { ?> 
     ...
     <div class="grid_8 esparriba5 colorAzul"><span class="f11 negrilla colorAzul grid_3">Subcategoria : </span><span class=" grid_4"><?php echo $nom_subcategoria; ?></span></div>        
    ...
    <div class="grid_8"> 
        ...
        <span class="f11 negrilla colorAzul">Codigo : </span><input class="input_redond_300 " <?php echo $llave;?> type="text" name="codigo_generado" id="cod" readonly="readonly" placeholder="Codigo autogenerado"value="<?php echo $cod; ?>"/>
