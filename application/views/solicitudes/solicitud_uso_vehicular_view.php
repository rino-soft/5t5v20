        ...
        <li>
            <fieldset>
                ...
                <div class="grid_2">
                    ...
                    <script>  $( "#fechaSalida" ).datepicker({'minDate':'+1d'}); </script>
                ...
                <div class="grid_2 esparriba"><input name="fechaRetorno" type="text" class="textChico" title="fecha de retorno" id="fechaRetorno" value="" size="10" value="<?php echo date('d/m/y')?>"/></div>
                <script>  $( "#fechaRetorno" ).datepicker({'minDate':'+1d'});  </script>
