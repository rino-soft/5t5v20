<html>
    ...
    <body class="nav-md" >
        <div id="bloqueo_pagina" class="ocultar" style="width: 100% ;height: 100% ; position: fixed ;background-color: rgba(10, 10, 10, 0.9) ; z-index: 200">
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile clearfix">
                            <div class="profile_pic">
                                <img src="<?php echo base_url() . $this->session->userdata('imagen') ?>" alt="..." class="img-circle profile_img">
                            </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <img src="<?php echo base_url() . $this->session->userdata('imagen') ?>" alt=""><?php echo $this->session->userdata('nombres') . " " . $this->session->userdata('apellidos') ?> 
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                        <li>
                                            <a>
                                                <span class="image"><img src="<?php echo base_url() . $this->session->userdata('imagen') ?>" alt="Profile Image" /></span>
                                                <span>
        ...
        <script src="<?php echo base_url(); ?>JS/rendiciones_nuevo.js"></script>
        ...
        <script src="<?php echo base_url(); ?>JS/control_proyecto.js"></script>
        <script src="<?php echo base_url(); ?>JS/fondosrendir.js"></script>
        <script src="<?php echo base_url(); ?>JS/caja_chica.js"></script>
        ...
        <script>
            $("#myDatepickerresumen").datetimepicker({
                ignoreReadonly: true,
