...
<?php if ($estado_vehi->num_rows() > 0) { ?>
    ...
    <input type="hidden" id="id_vehiculo_resp" value="<?php echo $dato_asignado->id_vehiculo_resp; ?>">
     <input type="hidden" id="asignado" value="<?php echo $dato_asignado->id_responsable; ?>">
       <?php
       if($dato_asignado->tipo_asignacion=="Proyecto"){
       ?>
        ...
        <input type="hidden" id="" value="<?php echo $dato_asignado->tipo_asignacion?>">
        ...
        <?php echo $per_a_asignar->nombre . " " . $per_a_asignar->ap_paterno . " " . $per_a_asignar->ap_materno; ?></div>
            ...
            <div class="grid_12" style="padding-top: 10px">
                ...
                <div class="grid_2 mayusculas"> <div class="" value=""><?php if ($selec_ciudad->nombre != "") echo $selec_ciudad->nombre;else echo "&nbsp;" ?> </div></div>
                <div class="grid_3 f11 negrilla" style="">Proyecto:</div>  
                <div class="grid_4 mayusculas"> <div class="" value=""><?php if ($proyecto_seleccionado->nombre != "") echo $proyecto_seleccionado->nombre;else echo "&nbsp;" ?> </div></div>
            ...
            <div class="grid_12" style="">
                ...
                <div class="grid_3 f11 negrilla" style="">Subcentro:</div>
                <div class="grid_2 mayusculas "> <div class="" value=""><?php if ($dato_asignado->subcentro != "") echo $dato_asignado->subcentro;else echo "&nbsp;" ?> </div></div>
        ...
        <div class="grid_12 f10 fondo_plomo_claro_areas ">
            <div class="grid_12">
                ...
                <div style="" class="bordeado mayusculas f12 colorBlanco fondo_azul alin_cen"> Nombre del Tecnico:
        <?php echo $dato_asignado->nombre_tecnico;?></div>


            </div>
            <div class="grid_12" style="padding-top: 10px">
                
                <div class="grid_3 f11 negrilla" style="">Nombre del Taller:</div>  
                <div class="grid_4 mayusculas"> <div class="" value=""><?php if ($dato_asignado->nombre_taller != "") echo $dato_asignado->nombre_taller;else echo "&nbsp;" ?> </div></div>
            </div>  
            <div class="grid_12 f10 fondo_plomo_claro_areas " style="padding-top: 10px">
                <div class="grid_3 f11 negrilla">Fecha de asignacion:</div>
                <div class="grid_2">
