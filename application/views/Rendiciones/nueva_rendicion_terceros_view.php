...
<!--            //<input class="input_redond_200" type="hidden" id="fechaS" readonly="readonly" value=" <?php //echo date("Y-m-d H:i:s");                                                          ?>" placeholder="">  -->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" >
            <div class='col-md-9 col-sm-9 col-xs-12'>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    Tipo : <br>
                    <select id="tipo_rendicion" class="form-control" >
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    Proyecto: <br><select id="id_proy_sitio" class="form-control" onchange="cargar_sitiosproyecto()">
        ...
        <div id="ayuda_autocomplete">
            <script> //cargar_sitiosproyecto();</script>
        </div>
