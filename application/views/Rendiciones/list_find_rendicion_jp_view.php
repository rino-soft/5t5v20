    ...
    if ($total_registros != 0) {
            ...
            <div class="grid_20 borde_abajo  cambio_fondo esparriba10  " style="width: 100%" id="div<?php echo $reg->idreg_ren; ?>">
               ...
               <!-- <div class="f12 alin_cen " style="display: block-inline;float: left; width: 12%"><?php //echo $reg->estado; ?></div> -->
                ...
                <div  style="display: block-inline;  float: left; width: 9%">
                    ...
                    <div class="editar_rendicion milink" title="Editar" onclick="">
                        
                        
                    </div>
                    <div class="enviar_rendicion milink" title="Enviar" onclick="">
                        
                        
                    </div>
                    <div class="impresionDoc milink" title="Imprimir PDF" onclick="">
        ...
        echo '';
    ?>
        <input class="" id="cont_id_rend" type="text" value="">
