...
<div class="col-md-6 col-sm-6 col-xs-12  alert alert-info alert-dismissible fade in">
    <!--onclick="mostrar_fomrulario_nueva_rendicion_terceros(0);" >-->
    <div class="col-md-6 col-sm-6 col-xs-12 negrilla f14" style="color:black">Para registrar una nueva Rendicione Seleccione un usuario.</div>
...
<div class="ocultar" id="relacion_documento">
    <div class="col-md-12 col-sm-12 col-xs-12 " >
        <div class="col-md-6 col-sm-6  col-xs-12 " i>
            <div class="x_panel" id="div_caja_chica" atyle="color:#FF0000 ">

            </div> 
        </div> 
        <div class="col-md-6 col-sm-6  col-xs-12 ">

            <div class="x_panel" id="div_fRendir" atyle="color:#FF0000 ">
