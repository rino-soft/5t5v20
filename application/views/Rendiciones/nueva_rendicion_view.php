...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <spam class="f16">Registro de Rendicion </spam>
...
<!--            //<input class="input_redond_200" type="hidden" id="fechaS" readonly="readonly" value=" <?php //echo date("Y-m-d H:i:s");                                       ?>" placeholder="">  -->
            ...
            <div class='col-md-8 col-sm-8 col-xs-12'>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select id="tipo_rendicion" >
                        <option value="Rendicion" <?php if ($tipo_rendicion == "Rendicion") echo "selected='selected'"; ?> > Rendicion de fondos(Fondos a Rendir)</option>
                        <option value="Reembolso" <?php if ($tipo_rendicion == "Reembolso") echo "selected='selected'"; ?> > Reembolso de gastos(Caja Chica)</option>
                    </select>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    Usuario:
                    <select id="tecnico_seleccionado" >
                        ...
                        {
                            ?>
                        <option value="<?=$user->cod_user?>" ><?=$user->ap_paterno." ".$user->ap_materno.",".$user->nombre?></option>
                            <?php
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 ">
            ...
            <div id="grilla_modelo" class="oculto">
                <div class="bordeado col-md-12 col-sm-12 col-xs-12 esparriba5 espabajo5 fondo_plomo_claro_areas" style="position: relative" >
      ...
      <!--                        <script>carga_tipo_gasto('tipo_gasto_for', 'selec_tipo_servg', 'gasto_bloque', 0);</script>-->
                    ...
                    <div class="gcol-md-2 col-sm-2 col-xs-12" title="ingrese el detalle de la factura">
                        ...
                        <textarea id="detalle_factura" style="width: 145px; height: 27px;font-size: 10px;padding: 0px;"></textarea>
                    </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" id="add_nuevo_rendicion">  
                        ...
                        if ($datos_rendicion_detalle_traA->num_rows() > 0) {
                            ...
                            foreach ($datos_rendicion_detalle_traA->result() as $fila) {
                                ...
                                <div id="dr<?php echo $cont; ?>" class="">
                                    <div class="gcol-md-12 col-sm-12 col-xs-12 esparriba5 espabajo5 fondo_azulclaro_c_borde" style="position: relative">
                                        ...
                                        <div class="gcol-md-2 col-sm-2 col-xs-12" title="ingrese el detalle de la factura">
                                            <div class="f10 negrilla centrartexto">Detalle Factura</div>
                                            <textarea id="detalle_factura" style="width: 145px; height: 27px;font-size: 10px; padding: 0px"><?php echo $fila->glosa; ?></textarea>
                                        </div>
                                        ...
                                        <div class="gcol-md-2 col-sm-2 col-xs-12" title="archivos adjuntos">
                                            ...
                                            <div class="f10 negrilla centrartexto milinktext" title="Click para adjuntar archivos" onclick="$('#userfile<?php echo $cont; ?>').trigger('click');">Archivos adjuntos</div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 ">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12 negrilla f20" id="monto_total_rendicion">
                <?php echo number_format($sumador, 2, ".", ","); ?>
            </div>  
            <div class="col-md-3 col-sm-3 col-xs-12 form-group bordeado">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 form-group alin_der">
            <button type="button" class="btn btn-dark  has-feedback" style="margin-right: 0;" onclick="mostrar_fomrulario_nueva_rendicion(0);" >Nueva Rendicion</button>
