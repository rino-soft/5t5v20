...
<!--            //<input class="input_redond_200" type="hidden" id="fechaS" readonly="readonly" value=" <?php //echo date("Y-m-d H:i:s");  ?>" placeholder="">  -->
    ...
    <div class="grid_20 NO centrartexto f20">FACTURAS RECHAZADAS</div>
    <div class="grid_10" >
        <div class="grid_10 " >
    ...
    <div class="grid_20 ">
            ...
            if ($id_rend != 0) {
                ...
                foreach ($datos_rendicion_detalle->result() as $fila) {
                    ...
                    <div id="dr<?php echo $cont; ?>" class="">
                        <div class="grid_20 esparriba5 espabajo5 bordeado NO">
                            <div class="grid_2">
        ...
        <!--                                    <div id="dialog_nom_arch<?php //echo $cont;     ?>" class="centrartexto">
                            ...
                            <!--                            <div class=" grid_1 " style="margin-top: 15px; width: 30px;">
                                                            <div class="delete_ico" onclick="enviar_baul_rechazados('<?php //echo $fila->id_det;  ?>')" title="devolver registro"></div>
                                                        </div>-->



                            <div class="grid_20"><span class="negrilla">observaciones de Rechazo.-</span>
                                    <?php echo $fila->obs_detalle_estado; ?>
                            </div>
    ...
    <div class="grid_20">
        ...
        <div class="grid_8 NO espabajo5 esparriba5">
