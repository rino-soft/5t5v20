    ...
    <div style="display: table-row">
        ...
        <div style="display: table-cell;">
            <div style="float:right; display: table-cell; " class="alin_der">
                <input class="fondobuscar300" id="search_rendicion" placeholder="B U S C A R" onkeypress="search_ren(event);">
                 <br> Nro de Registros :
                <select id="mostrarX" onchange="$('#pagina_registros').val(1);  search_and_list_rendicion('lista_rendicion');">
...
<script> search_and_list_rendicion('lista_rendicion');</script>
