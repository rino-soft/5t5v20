    ...
    <div style="display: table-row">
         ...
         <div  style="height: 35px ;display: table-cell; padding:5px 5% 5px 5px; float: left">
            ...
            <div class="boton milink negrilla"  style="float: left; display: table-cell" 
                 onclick="dialog_nuevo_for_rendicion('div_formularios_dialog','<?php echo base_url() . "rendiciones/nueva_rendicion/0"; ?>','Nueva Rendicion')">
         ...
         <div style="display: table-cell;">
            <div style="float:right; display: table-cell; " class="alin_der">
                <input class="fondobuscar300" id="search_rendicion" placeholder="B U S C A R" onkeypress="search_rr(event);">
                 <br> Nro de Registros :
                <select id="mostrarX" onchange="$('#pagina_registros').val(1);  search_and_list_mis_rendiciones_rr('lista_rendicion');">
...
<script> search_and_list_mis_rendiciones_rr('lista_rendicion');</script>
