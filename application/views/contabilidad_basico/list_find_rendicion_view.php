    ...
    if ($total_registros != 0) {
        ...
        <div class="fondo_azul colorAmarillo borde_abajo borde_arriba  negrilla f14" style="display: block-inline;float: left ; width: 100%; height: ">            
           ...
           <!-- <div class=" fondo_azul alin_cen" style="display: block-inline;float: left ;width: 12%">Estado</div> -->
            ...
            <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 10%">Datos de Registro</div>
            <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 20%">Proyecto</div>
            <div  class=" fondo_azul alin_cen" style="display: block-inline; float: left;width: 40%">Observaciones</div>
        ...
        <?php foreach ($registros->result() as $reg) { ?>
            <div class="grid_20 borde_abajo  cambio_fondo esparriba10  " style="width: 100%">
                <div class="f14 alin_cen negrilla colorRojo" style="display: block-inline;float: left; width: 10%"> <?php echo $reg->idreg_ren; ?></div>
               <!-- <div class="f12 alin_cen " style="display: block-inline;float: left; width: 12%"><?php //echo $reg->estado; ?></div> -->
                <div class="f12 " style="display: block-inline;  float: left; width: 15%"><?php echo $reg->nombre . " " . $reg->ap_paterno . " " . $reg->ap_materno . '<br><span class="colorcel negrilla">CI.: </span> <span class=" colorGuindo negrilla"> '.$reg->ci.'</span>'; ?></div>
                <div class="f12 alin_cen" style="display: block-inline;float: left; width: 10%"><?php echo $reg->fh_registro; ?></div>  
                <div class="f12 alin_izqS " style="display: block-inline; float: left; width: 20%"><?php echo $reg->nombre_proyecto .'<br><span class=" colorAzul negrilla">'.$reg->descripcion.'</span>'; ?></div>
                <div class="f10 espizq10" style="display: block-inline;float: left; width: 30%"><?php if ($reg->observacion != "") echo $reg->observacion;else echo " &nbsp;" ?></div>
